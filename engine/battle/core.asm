...
.noLinkBattle
	...
	PRIORITY_MOVE_ASM VACUUM_WAVE
	PRIORITY_MOVE_ASM SUCKER_PUNCH
	PRIORITY_MOVE_ASM ICE_SHARD
	PRIORITY_MOVE_ASM BULLET_PUNCH
	PRIORITY_MOVE_ASM EXTREMESPEED
	PRIORITY_MOVE_ASM AQUA_JET
...
DisplayPlayerBag:
	ld a, [W_CURMAP]
	cp BATTLE_FACTORY
	jp z, DisplayBattleMenu ; don't open battle item menu in the battle factory
	ld a, [W_ISLINKBATTLE]
	cp $4
...
UnknownMovesList_3dba3: ; 3dba3 (f:5ba3)
	...
	db $00
	db RECOVER, DOOM_DESIRE, SELFDESTRUCT, AMNESIA
	db $00
...
.animateHpBar
	...
	xor a
	ld [wListMenuID],a
	predef UpdateHPBar_Hook ; animate the HP bar shortening
...
BurnEffect: ; 3f9b1 (f:79b1)
	ld hl, BurnEffect_
	ld b, BANK(BurnEffect_)
	jp Bankswitch
